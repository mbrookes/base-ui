...
<InstallationBlock className="bui-mt-5 bui-mb-6" package="@base-ui/react" />
...
This demo shows you how to import the [Chat](/react/components/chat) components, assemble their parts, and apply styles.
There are examples for both Tailwind and CSS Modules below, but since Base UI Chat is unstyled, you can use CSS-in-JS, plain CSS, or any other styling solution you prefer.

import { DemoChatHero } from '../../components/chat/demos/hero';
...
Continue to the [Handbook](/react/handbook/styling) section for broader guidance on topics like styling, animation, and composition, or explore the [components](/react/components/accordion).
