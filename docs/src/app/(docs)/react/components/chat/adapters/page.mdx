...
```ts
import type { ChatAdapter } from '@base-ui/react/chat';
...
For the complete chunk type reference, see [Streaming](/react/components/chat/streaming/).
...
See [Error handling](/react/components/chat/error-handling/) for the full error model.

## See also

- [Streaming](/react/components/chat/streaming/) for the stream lifecycle and chunk type reference.
